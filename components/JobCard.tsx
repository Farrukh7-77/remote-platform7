// components/JobCard.tsx - Larger hover shadow
"use client";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mt-3">
        ...
        {/* Posted time as badge on the right */}
        <span className="inline-flex items-center px-2 py-1 text-xs bg-gray-100 text-gray-500 rounded-full">
          📅 {relativeTime}
        </span>
      </div>
    </div>
